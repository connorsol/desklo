...
const stats = [
  ...
  { label: 'Leads Captured', value: '43', change: '+8%', icon: UserPlus },
  { label: 'After-Hours Conversations', value: '31', change: '+24%', icon: Moon },
  { label: 'Total All Time', value: '1,284', change: null, icon: BarChart3 },
];
      ...
      <header className="h-16 border-b border-gray-100 bg-white flex items-center px-6 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto w-full flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="hidden sm:block text-sm font-medium text-gray-600">Acme Plumbing</span>
          </div>
