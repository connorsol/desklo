...
const steps: Record<string, { title: string; description: string; highlight?: string }[]> = {
  wix: [
    ...
    { title: 'Click Custom Code', description: 'Under Settings, find and click "Custom Code".' },
  ...
  wordpress: [
    ...
    { title: 'Go to Appearance → Theme Editor', description: 'In the left sidebar click Appearance, then Theme File Editor.' },
    { title: 'Open footer.php', description: 'In the right sidebar find and click footer.php.' },
    { title: 'Paste the embed code', description: 'Paste both lines of your embed code just before the </body> tag.', highlight: '</body>' },
    { title: 'Save changes', description: 'Click "Update File" to save. Your AI receptionist is now live!' },
  ],
  squarespace: [
    { title: 'Open your Squarespace dashboard', description: 'Log in to your Squarespace account and open your site.' },
    { title: 'Go to Settings', description: 'Click Settings in the left sidebar.' },
    { title: 'Click Advanced', description: 'Scroll down and click "Advanced" in the settings menu.' },
    ...
    { title: 'Save', description: 'Click Save. Your AI receptionist is now live!' },
  ],
  shopify: [
    ...
    { title: 'Open theme.liquid', description: 'In the file list on the left, find and click theme.liquid.' },
    { title: 'Paste the embed code', description: 'Paste both lines of your embed code just before the </body> tag.', highlight: '</body>' },
    { title: 'Save', description: 'Click Save. Your AI receptionist is now live!' },
  ],
  other: [
